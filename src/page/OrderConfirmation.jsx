  ...
  return (
    <section className={styles.container}>
      <div className={styles.card}>
        ...
        <p className={styles.subtitle}>
          Gracias {order.userFullName}, tu pedido fue recibido exitosamente.
        </p>

        <div className={styles.meta}>
          <span className={styles.orderId}>Orden: {order.orderNumber}</span>
        ...
        <div className={styles.section}>
          ...
          {order.items.map((item) => (
            <div key={item.id} className={styles.item}>
              ...
              <span className={styles.itemPrice}>{formatCOP(item.unitPrice * item.quantity)}</span>
            </div>
          ))}
        </div>
